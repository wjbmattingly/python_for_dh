...
# You should now feel comfortable with creating, reading, and saving DataFrames. You should also be comfortable with adding columns and indexing by rows. If you want to explore Pandas in more depth, check out my textbook, <a href="pandas.pythonhumanities.com">Introduction to Pandas</a>. There is a lot more to explore with Pandas, but this should give you the ability to begin working with tabular data in Python.
